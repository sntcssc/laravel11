...
@section('content')
<div class="container">
    <h2>Create SFG Program Knowledge</h2>
    <form action="{{ route('sfg_program_knowledges.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="unique_id" id="unique_id" class="form-control" value="{{ old('unique_id') }}" required>
            @error('unique_id')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="key_features_of_sfg_program" id="key_features_of_sfg_program" class="form-control" required>{{ old('key_features_of_sfg_program') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="ways_sfg_will_help_in_exam" id="ways_sfg_will_help_in_exam" class="form-control" required>{{ old('ways_sfg_will_help_in_exam') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <select name="regular_analysis_of_prelims_performance" id="regular_analysis_of_prelims_performance" class="form-select" required>
                ...
                <option value="1" {{ old('regular_analysis_of_prelims_performance') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('regular_analysis_of_prelims_performance') == 0 ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="identifying_weak_areas_after_tests" id="identifying_weak_areas_after_tests" class="form-select" required>
                <option value="">Select</option>
                <option value="1" {{ old('identifying_weak_areas_after_tests') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('identifying_weak_areas_after_tests') == 0 ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <textarea name="benefits_from_prelims_analysis" id="benefits_from_prelims_analysis" class="form-control" required>{{ old('benefits_from_prelims_analysis') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="working_to_eliminate_weak_areas" id="working_to_eliminate_weak_areas" class="form-control" required>{{ old('working_to_eliminate_weak_areas') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <select name="reading_test_explanations" id="reading_test_explanations" class="form-select" required>
                <option value="">Select</option>
                <option value="1" {{ old('reading_test_explanations') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('reading_test_explanations') == 0 ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="taking_notes_from_explanations" id="taking_notes_from_explanations" class="form-select" required>
                <option value="">Select</option>
                <option value="1" {{ old('taking_notes_from_explanations') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('taking_notes_from_explanations') == 0 ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="regular_test_participation" id="regular_test_participation" class="form-select" required>
                <option value="">Select</option>
                <option value="1" {{ old('regular_test_participation') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('regular_test_participation') == 0 ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <textarea name="test_participation_challenges" id="test_participation_challenges" class="form-control" required>{{ old('test_participation_challenges') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="overcoming_test_challenges" id="overcoming_test_challenges" class="form-control" required>{{ old('overcoming_test_challenges') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="highest_test_score" id="highest_test_score" class="form-control" value="{{ old('highest_test_score') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="lowest_test_score" id="lowest_test_score" class="form-control" value="{{ old('lowest_test_score') }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="average_test_score" id="average_test_score" class="form-control" value="{{ old('average_test_score') }}" required>
        ...
        <div class="mb-3">
            ...
            <select name="belief_in_clearing_prelims_this_year" id="belief_in_clearing_prelims_this_year" class="form-select" required>
                <option value="">Select</option>
                <option value="1" {{ old('belief_in_clearing_prelims_this_year') == 1 ? 'selected' : '' }}>Yes</option>
                <option value="0" {{ old('belief_in_clearing_prelims_this_year') == 0 ? 'selected' : '' }}>No</option>
            </select>
