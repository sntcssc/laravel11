...
<div class="container">
    ...
    <form action="{{ route('personality_details.update', $personalityDetail->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="student_id" class="form-select">
                ...
                @foreach ($students as $student)
                    <option value="{{ $student->id }}" {{ old('student_id', $personalityDetail->student_id) == $student->id ? 'selected' : '' }}>{{ $student->name }}</option>
                @endforeach
            </select>
        ...
        <div class="mb-3">
            ...
            <textarea name="reason_for_civil_services" class="form-control">{{ old('reason_for_civil_services', $personalityDetail->reason_for_civil_services) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="essential_values_for_topping" class="form-control">{{ old('essential_values_for_topping', $personalityDetail->essential_values_for_topping) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="motivation_for_daily_effort" class="form-control">{{ old('motivation_for_daily_effort', $personalityDetail->motivation_for_daily_effort) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="strengths_in_clearing_exams" class="form-control">{{ old('strengths_in_clearing_exams', $personalityDetail->strengths_in_clearing_exams) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="areas_for_improvement" class="form-control">{{ old('areas_for_improvement', $personalityDetail->areas_for_improvement) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="obstacles_to_success" class="form-control">{{ old('obstacles_to_success', $personalityDetail->obstacles_to_success) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="current_challenges" class="form-control">{{ old('current_challenges', $personalityDetail->current_challenges) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="overcoming_challenges_plan" class="form-control">{{ old('overcoming_challenges_plan', $personalityDetail->overcoming_challenges_plan) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="strategies_for_success" class="form-control">{{ old('strategies_for_success', $personalityDetail->strategies_for_success) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="major_distractions" class="form-control">{{ old('major_distractions', $personalityDetail->major_distractions) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="distraction_overcoming_plan" class="form-control">{{ old('distraction_overcoming_plan', $personalityDetail->distraction_overcoming_plan) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="distraction_timeline" class="form-control">{{ old('distraction_timeline', $personalityDetail->distraction_timeline) }}</textarea>
