...
class StudentController extends Controller
{
    ...
    public function verifyStudent(Request $request)
    {
        try {
            ...
            if ($student) {
                ...
                // return redirect()->route('step1_form'); // Change 'step1_form' to your actual next route
            ...
            // Specific handling for the case when no student is found
    ...
    //         if (!$student) {
    //             return back()->withErrors(['error' => 'Student details do not match'])->withInput();
    //         }
    ...
    //     } catch (\Exception $e) {
    //         dd($e->getMessage());
    //         Log::error('Error in verifying student: ' . $e->getMessage());
